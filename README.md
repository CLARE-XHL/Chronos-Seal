...
└── encrypt_config.json               ← 由 build.bat 自动生成
...
参数 说明 示例
游戏版本号 游戏当前版本，用于派生发行密钥 1.0.0
发行日期 游戏发行日期，用于派生发行密钥 2026-08-30
游戏名称 用于生成注册表路径 MyGame
...
参数 说明 默认值
HARD_EXPIRE 时间炸弹截止时间戳 1767225600（2027-01-01）
...
错误码 含义 玩家看到的消息
10 ERR_EXPIRED 游戏版本已过期，请到 Steam 更新
20 ERR_ID_MISMATCH Steam 账号不匹配，请使用购买游戏的账号登录
30 ERR_SIGNATURE 授权文件损坏，请重新安装游戏
31 ERR_TIME_TAMPER 系统时间异常，请同步时间后重试
40 ERR_NO_RES 游戏文件缺失，请验证游戏完整性或重装
50 ERR_NO_STEAM 请先启动 Steam 客户端
-1 ERR_UNKNOWN 授权失败，错误码: -1（请联系开发者）
