...
> 📖 **在开始之前，建议你先读完「指南」中的快速开始（版本对比与缺陷）部分，了解 Chronos Seal 的定位、缺陷与门槛，再决定它是否适合你的项目。**


## 基础环境准备

在开始部署 Chronos Seal Basic 版之前，你需要做好以下准备工作：
...
**GitHub**：你在使用 Actions 时，为了安全，需要将模板仓库 Fork 到自己的账户下并设为私有仓库，防止你的密钥派生种子等敏感参数被他人盗取。而且 GitHub 上也有很多优秀开源项目，账号注册十分容易，不亏。
...
接下来请前往 [使用 JS 插件与布入事件](/basic/using-plugin)。
